...
[Big Transfer (BiT): General Visual Representation Learning](https://arxiv.org/abs/1912.11370)通过研究“pre-training + fine-tuning”范式，提出BiT策略，在上游任务基于大量数据对大模型进行预训练，然后通过低成本微调将模型迁移至下游任务。
